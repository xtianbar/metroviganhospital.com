...
function createArticleCardHTML(article) {
    ...
    return `
        <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition mb-12">
            <img src="${thumbnailUrl}" alt="${article.title}" class="w-full h-62 object-cover" onerror="this.onerror=null;this.src='https://placehold.co/600x400/cccccc/ffffff?text=Image+Not+Found';">
            <div class="p-6">
